    ...
    def extract(self, decision_text: str, request_id: str, company_id: str) -> DecisionExtractionResponse:
        ...
        for attempt in range(self.max_retries + 1):
            ...
            try:
                ...
                governance_result = evaluate_governance(decision, company_context=None, company_id=company_id)
        ...
        governance_result = evaluate_governance(fallback_decision, company_context=None, company_id=company_id)
