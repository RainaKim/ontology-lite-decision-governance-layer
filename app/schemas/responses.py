...
class ValidationPayload(BaseModel):
    """Governance agent validation result — nested model."""
...
class ConsolePayloadResponse(BaseModel):
    ...
    # --- Governance Agent (Layer 2) validation result ---
    # Nested model replaces the 5 flat fields. Backward compatible (Optional).
    validation: Optional[ValidationPayload] = None
